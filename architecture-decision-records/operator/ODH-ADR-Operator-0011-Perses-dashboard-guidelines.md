...
Component teams create dashboards as `PersesDashboard` Custom Resources in the operator's monitoring resources directory: `internal/controller/services/monitoring/resources/`.
...
**Real Example - Tempo Tracing Dashboard:**
...
- [ODH-ADR-Operator-0010: Observability Component Metrics Scraping Guidelines](ODH-ADR-Operator-0010-Observability-component metrics scraping.md)
- [ODH-ADR-Operator-0009: Observability and Tracing Strategy](ODH-ADR-Operator-0009-Observability-and-Tracing-Strategy.md)
